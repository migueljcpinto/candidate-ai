    ...
    <div className="container pt-5 pb-5 space-y-3">
      ...
      <div className="text-sm p-5 space-y-3 md:text-base">
        <div className=" bg-primary/10 rounded-xl border-2 space-y-5 p-5">
          ...
          <p>
            Foram usadas várias tecnologias, incluindo Next.js, React,
            Typescript, Tailwind, Prisma, ferramentas de criação de imagens e
            conversação (Open AI) e Clerk para autenticação eficiente.
          </p>
        </div>
